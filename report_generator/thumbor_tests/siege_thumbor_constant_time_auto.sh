...
THUMBOR_OUT_FILE=./results/thumbor_CTA_"$SEED"_"$CONCURRENT"_"$TIME"_$(date +%Y-%m-%d_%H-%M-%S).csv
...
python3 csv_to_html.py html_tables/thumborConstantTimeResults.html $THUMBOR_OUT_FILE
