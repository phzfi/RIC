...
python3 csv_to_html.py html_tables/ricThumborConstantRequestsResultsAuto.html $RIC_OUT_FILE_BEFORE $RIC_OUT_FILE_AFTER $THUMBOR_OUT_FILE_BEFORE $THUMBOR_OUT_FILE_AFTER
