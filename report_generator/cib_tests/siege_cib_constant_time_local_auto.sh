...
CIB_OUT_FILE=./results/cib_CTLA_"$SEED"_"$CONCURRENT"_"$TIME"_$(date +%Y-%m-%d_%H-%M-%S).csv
...
python3 csv_to_html.py html_tables/cibConstantTimeResultsLocal.html $CIB_OUT_FILE
