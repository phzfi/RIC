...
python3 csv_to_html.py html_tables/ricCibThumborConstantRequestsResultsAuto.html $RIC_OUT_FILE_BEFORE $RIC_OUT_FILE_AFTER $CIB_OUT_FILE_BEFORE $CIB_OUT_FILE_AFTER $THUMBOR_OUT_FILE_BEFORE $THUMBOR_OUT_FILE_AFTER
