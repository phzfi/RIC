...
class TestGenerator(unittest.TestCase):
    ...
    def test_read_text_correct(self):
        ...
        for i in range(9):
            self.assertEqual(data[i], [float(i), i * 10, '/images/14857596084_b0105b8e88_o.jpg', 'HTTP/1.1 200'],
    ...
    def test_read_log(self):
        ...
        self.assertEqual(data['2015-10-29 16.34.29'], ['2015-10-29 16:34:29', '400', '24.50', '833',
                                                       '0.54', '16.33', '34.00', '8.88', '400', '0'],
                                                       'wrong data value 1')
        self.assertEqual(data['2015-10-29 16.35.45'], ['2015-10-29 16:35:45', '400', '25.39', '833', 
                                                       '0.60', '15.75', '32.81', '9.40', '400', '0'],
                                                       'wrong data value 2')
        self.assertEqual(data['2015-10-29 16.53.23'], ['2015-10-29 16:53:23', '400', '23.98', '833',
